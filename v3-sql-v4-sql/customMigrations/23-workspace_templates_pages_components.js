...
const processedTables = ["workspace_templates_pages_components"];

async function migrateTables() {
  await migrate(
    "workspace_templates_pages_components",
    "workspace_templates_pages_components",
    (item) =>
      omit(
        {
          ...item,
          entity_id: item.workspace_templates_page_id,
